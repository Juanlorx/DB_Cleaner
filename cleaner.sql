...
/*A.Retorna un listado con la ciudad y el teléfono de las oficinas de España.*/
...
/*B.Retorna un listado con el nombre, apellidos y email de los empleados cuyo jefe tiene un código de jefe igual a 7.*/
...
/*D.Retorna un listado con el nombre, apellidos y puesto de aquellos empleados que no sean representantes de ventas.*/
...
select codigo_pedido, estado, fecha_pedido, fecha_esperada
from pedido
